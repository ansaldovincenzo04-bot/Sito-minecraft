...
// Safety fallback: se strings.js non è caricato, il sito non crasha
if (typeof BASE_STRINGS === "undefined") {
    console.error("ERRORE: strings.js non trovato! Assicurati che sia nel repo GitHub.");
    window.BASE_STRINGS = {};
    window.LANGUAGES = [{ code: "it", label: "Italiano", flag: "🇮🇹" }];
    window.STRINGS_VERSION = "v6";
}
